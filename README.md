...
**Traditional Chinese divination app with 8 modes -- I Ching, Mei Hua, Plum Blossom, and more**

[![license](https://img.shields.io/badge/license-AGPL%20v3-blue)](LICENSE)
[![version](https://img.shields.io/badge/version-A%200.8.5-aa8844)]
[![status](https://img.shields.io/badge/status-8+Modes%20Ready-success)]
[![stars](https://img.shields.io/github/stars/luyi14-bits/AskTheOracle?style=social)](https://github.com/luyi14-bits/AskTheOracle/)

> 🎋 心存疑问，掷爻问天 — 一枚精致的开源算卦小玩具。

[在线体验](https://luyi14-bits.github.io/AskTheOracle/) (手机浏览器打开可安装到桌面)
...
| **A 0.8.5** | 交叉起卦 + 掐指小六壬 + 五格姓名学 -- 八模式就绪 | ✅ 已发布 |
